...
| **30101** | panel-registration-ui (PCB Loader) | In use — [`panel-registration-ui/`](panel-registration-ui/) |
...
| [`panel-registration-ui/`](panel-registration-ui/) | Panel Registration UI (PCB Loader) promote + smoke |
